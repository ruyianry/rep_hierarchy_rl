...
CONFIG_deterministic = [
    [
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 5, "stride": 1,
         "weightnorm": True, "gated": False},
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 5, "stride": 1,
         "weightnorm": True, "gated": False},
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 5, "stride": 2,
         "weightnorm": True, "gated": False}
    ],
    [
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 3, "stride": 1,
         "weightnorm": True, "gated": False},
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 3, "stride": 1,
         "weightnorm": True, "gated": False},
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 3, "stride": 2,
         "weightnorm": True, "gated": False}
    ],
    [
        {"block": "ResBlockConv2d", "out_channels": 64, "kernel_size": 3, "stride": 1,
...
args.test_dataset_name = 'FashionMNISTBinarized'
